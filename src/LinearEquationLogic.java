...
public class LinearEquationLogic {
    ...
    private void getCoords(){
        ...
        int y1 = Integer.parseInt(coord1.substring(commaidx + 1, coord1.length()-1));

        int commaidx2 = coord2.indexOf(",");
        int x2 = Integer.parseInt(coord2.substring(1, commaidx2));
        int y2 = Integer.parseInt(coord2.substring(commaidx2 + 1, coord1.length()-1));

        linear = new LinearEquation(x1, y1, x2, x2);
